...
{
    public override string PortraitPath => "res://STS2_Mulundus/images/card_portraits/exact_vengeance.png";
    public ExactVengeance() : base(1, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
    {
        WithCalculatedDamage(7, 3, (card, _) => CombatManager.Instance.History.Entries.OfType<DamageReceivedEntry>().Count(e => e.Receiver == card.Owner.Creature && e.Dealer is { IsMonster: true }));
    }
